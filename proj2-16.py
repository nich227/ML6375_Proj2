...
x_train = np.loadtxt("x_train16.csv", dtype="uint8", delimiter=",")
y_train = np.loadtxt("y_train16.csv", dtype="uint8", delimiter=",")
...
model2 = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Dense(20, activation=tf.keras.activations.elu),
